...
let app = {
 ...
 let outputInfo = document.querySelector("#addDate");
        ...
        cordova.plugins.notification.local.getAll(results => {
            // ids is an array of all the ids for notifications in all categories
            console.log("Pimer" + results);
            ...
            results.sort((a, b) => {
                ...
                deleteIcon.setAttribute("idFromEv", item.id);
    ...
    addNote: function (ev) {
        ...
        console.log("probando" + dateInput.value);
